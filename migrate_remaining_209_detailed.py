#!/usr/bin/env python3
"""Script para migrar las subcategorías restantes del libro 209 con detalle."""
import sys
...
def migrate_remaining_209_detailed():
    db = next(get_dest_db())
    
    try:
        print("=== MIGRANDO SUBCATEGORÍAS RESTANTES DEL LIBRO 209 ===")
        
        # Migrar una por una para ver errores
        subcats = [(80, 4), (81, 5), (82, 6)]
...
if __name__ == "__main__":
    migrate_remaining_209_detailed()
