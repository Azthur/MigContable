#!/usr/bin/env python3
"""Script para limpiar registros de staging del libro 209 para regeneración desde ETL con nuevas reglas."""
import sys
...
def clear_staging_209_again():
    db = next(get_dest_db())
    
    try:
        print("=== LIMPIANDO STAGING DEL LIBRO 209 PARA REGENERACIÓN ===")
        ...
        print("\nStaging limpio. Ahora puedes ejecutar los ETL pipelines para regenerar los datos con las nuevas reglas.")
